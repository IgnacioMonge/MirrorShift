...
PUBLIC _netchesszx_asm_move_tail_ok
...
_netchesszx_session_send_ack_move:
    ld bc, _NETCHESS_PROTO_NACK_PREFIX + 1
...
cpb_token_loop:
    ...
    inc c
    djnz cpb_token_loop
    ; Exact cap-1 tokens exhaust B. Do not fall through into copy_digits.
    jr cpb_done
