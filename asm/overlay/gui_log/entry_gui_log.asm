...
; Notifications now have their own cold overlay; preserve the old slot ID.
_gui_log_notify_msg_ovl_entry:
    ld l, 0
    ret
...
_clear_move_line:
    ...
    ld b, 31
    call cll_loop
    ; Each separately positioned column must terminate even before a move.
    ; Otherwise an empty first column draws the second at offset 18 as well.
    xor a
    ld (hl), a
    ld de, -18
    add hl, de
