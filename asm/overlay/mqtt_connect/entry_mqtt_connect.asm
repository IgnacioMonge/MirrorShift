...
mqtt_conn_fixed_header:
    ; $02 is clean session without a will. Host construction below changes it
    ; to $06 and appends a live, non-retained F <side> <sid> will. Guests have
    ; no authoritative sid at CONNECT time, so they deliberately have no will.
