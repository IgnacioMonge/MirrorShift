...
; Stable entry table used by resident screen stubs.
    ...
    jp _spectrum_render_piece_palette
    jp _spectrum_next_setup_pieces_use_final
    jp next_square_sprite_slot
    jp next_hide_hardware_sprite
    jp next_draw_piece_sprite_16x16
    jp _spectrum_flip_blit_frame
    jp _spectrum_animate_last_flip
    jp _spectrum_animate_set_morph
    jp _spectrum_animate_convergence
    jp _spectrum_piece_masks_stash
    jp screen_cell_for_tmpcol
