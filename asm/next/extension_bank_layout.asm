...
next_ext_render_piece_palette EQU next_extension_org + 147
next_ext_setup_pieces_use_final EQU next_extension_org + 150
next_ext_square_sprite_slot EQU next_extension_org + 153
next_ext_hide_hardware_sprite EQU next_extension_org + 156
next_ext_draw_piece_sprite EQU next_extension_org + 159
next_ext_flip_blit_frame EQU next_extension_org + 162
next_ext_animate_last_flip EQU next_extension_org + 165
next_ext_animate_set_morph EQU next_extension_org + 168
next_ext_animate_convergence EQU next_extension_org + 171
next_ext_piece_masks_stash EQU next_extension_org + 174
next_ext_screen_cell_for_tmpcol EQU next_extension_org + 177
next_extension_table_size             EQU 180
...
next_sprite_source_pattern_count   EQU 12
next_sprite_pattern_count          EQU 28
next_capture_sprite_pattern_base   EQU 28
next_capture_sprite_pattern_count  EQU 14
next_common_sprite_offset          EQU next_sprite_offset + (3 * next_sprite_set_size)
next_common_sprite_pattern_base    EQU 42
...
next_sprite_palette_size           EQU 256
next_sprite_flash_palette_index    EQU 159
next_ula_standard_palette_size     EQU 128
