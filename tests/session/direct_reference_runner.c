...
const DirectParityScenario direct_parity_chat_rearms_liveness = {
    "chat-local-rearms-liveness",
    chat_rearms_liveness_steps,
    chat_rearms_liveness_expected,
    (uint8_t)(sizeof(chat_rearms_liveness_steps) /
              sizeof(chat_rearms_liveness_steps[0])),
    (uint8_t)(sizeof(chat_rearms_liveness_expected) /
              sizeof(chat_rearms_liveness_expected[0])),
    DIRECT_PARITY_ROLE_HOST,
    DIRECT_PARITY_COLOR_WHITE
};
...
const DirectParityScenario direct_parity_chat_send_fail = {
    "chat-send-fail",
    chat_send_fail_steps,
    chat_send_fail_expected,
    (uint8_t)(sizeof(chat_send_fail_steps) / sizeof(chat_send_fail_steps[0])),
    (uint8_t)(sizeof(chat_send_fail_expected) /
              sizeof(chat_send_fail_expected[0])),
    DIRECT_PARITY_ROLE_HOST,
    DIRECT_PARITY_COLOR_WHITE
};
...
static const uint8_t guest_smoke_hello[] =
    "HELLO DIRECT HOST WHITE=HOST";
static const uint8_t guest_white_hello[] =
...
static const uint8_t local_move[] = "d3";
static const uint8_t local_move_ack[] = "ACK 1 d3";
...
static const DirectParityObservation move_local_ack_expected[] = {
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 29u, 0u,
      "HELLO DIRECT HOST WHITE=GUEST" },
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 29u, 0u,
      "HELLO DIRECT HOST WHITE=GUEST" },
    { DIRECT_PARITY_OBS_READY, DIRECT_PARITY_LINK_NONE, 0u, 0u, 0u, "" },
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 22u, 0u,
      "GAME START WHITE=GUEST" },
    { DIRECT_PARITY_OBS_STARTED, DIRECT_PARITY_LINK_NONE, 0u, 0u, 0u, "" },
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 9u, 0u,
      "MOVE 1 d3" },
    { DIRECT_PARITY_OBS_GAME, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_GAME_LOCAL_MOVE, 2u, 1u, "d3" },
    { DIRECT_PARITY_OBS_CONTROL_RESULT, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_REQUEST_MOVE, 2u, DIRECT_PARITY_RESULT_ACCEPTED, "d3" },
    { DIRECT_PARITY_OBS_ENDED, DIRECT_PARITY_LINK_NONE, 0u, 0u, 0u, "" }
};
...
const DirectParityScenario direct_parity_move_local_ack = {
    ...
    DIRECT_PARITY_ROLE_HOST,
    DIRECT_PARITY_COLOR_BLACK
};

static const uint8_t local_move_stale_nack[] = "NACK 2 STALE";
static const uint8_t local_move_stale_ack[] = "ACK 2 d3";
...
static const uint8_t remote_move[] = "MOVE 1 d3";
static const uint8_t remote_start[] = "GAME START WHITE=HOST";
static const uint8_t remote_black_start[] = "GAME START WHITE=GUEST";

static const DirectParityStep move_remote_duplicate_steps[] = {
    { 0, DIRECT_PARITY_IN_LINK_UP, 1u, 0u, 0u, 0u, 0u },
    { guest_white_hello, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(guest_white_hello) - 1u), 0u, 0u, 0u },
    { remote_black_start, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(remote_black_start) - 1u), 0u, 0u, 0u },
...
static const DirectParityObservation move_remote_duplicate_expected[] = {
    ...
    { DIRECT_PARITY_OBS_STARTED, DIRECT_PARITY_LINK_NONE, 0u, 0u, 0u, "" },
    { DIRECT_PARITY_OBS_GAME, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_GAME_REMOTE_MOVE, 2u, 1u, "d3" },
...
static const uint8_t out_of_order_move[] = "MOVE 3 d6";
...
static const uint8_t local_black_move[] = "c3";
...
static const uint8_t remote_move_two[] = "MOVE 2 c3";
...
static const DirectParityObservation takeback_latch_next_move_expected[] = {
    ...
    { DIRECT_PARITY_OBS_CONTROL_RESULT, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_REQUEST_MOVE, 2u, DIRECT_PARITY_RESULT_ACCEPTED, "d3" },
    { DIRECT_PARITY_OBS_GAME, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_GAME_REMOTE_MOVE, 2u, 2u, "c3" },
...
static const uint8_t restore_active_2[] =
    "AAAAAAAAAAAAAAAAAAIQAAABIAAAAAAAAAAAAAAAAABAAAIAAQEAAAAAOwIP";
static const uint8_t restore_active_black[] =
    "AAAAAAAAAAAAAAAAAAIQAAABIAAAAAAAAAAAAAAAAABDAAIAAQEAAAAAOwLo";
static const uint8_t restore_rs00[] =
    "RS00 AAAAAAAAAAAAAAAAAAIQAAABIAAAAA";
static const uint8_t restore_rs01_ready[] =
    "RS01 AAAAAAAAAAAABAAAAAAAEAAAAAOwLM";
static const uint8_t restore_rs01_active[] =
    "RS01 AAAAAAAAAAAABAAAIAAQEAAAAAOwIP";
static const uint8_t restore_rs00_over_alt[] =
    "RS00 ERERERERERERERERERERERERERERER";
static const uint8_t restore_rs01_over_alt[] =
    "RS01 ERERERERERERFEAAQAAgEAAAAAOwJ1";
...
static const uint8_t restore_move[] = "d3";
static const uint8_t restore_move_ack[] = "ACK 3 d3";

static const DirectParityStep restore_local_active_steps[] = {
    { 0, DIRECT_PARITY_IN_LINK_UP, 1u, 0u, 0u, 0u, 0u },
    { host_smoke_hello, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(host_smoke_hello) - 1u), 0u, 0u, 0u },
    { restore_active_black, DIRECT_PARITY_IN_LOCAL, 1u,
      (uint8_t)(sizeof(restore_active_black) - 1u), 2u,
...
static const DirectParityObservation restore_local_active_expected[] = {
    ...
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 35u, 0u,
      "RS00 AAAAAAAAAAAAAAAAAAIQAAABIAAAAA" },
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 35u, 0u,
      "RS01 AAAAAAAAAAAABDAAIAAQEAAAAAOwLo" },
    { DIRECT_PARITY_OBS_GAME, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_GAME_RESTORE, 1u, 2u, "A" },
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 9u, 0u, "MOVE 3 d3" },
    { DIRECT_PARITY_OBS_GAME, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_GAME_LOCAL_MOVE, 2u, 3u, "d3" },
    { DIRECT_PARITY_OBS_CONTROL_RESULT, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_REQUEST_MOVE, 2u, DIRECT_PARITY_RESULT_ACCEPTED, "d3" },
    { DIRECT_PARITY_OBS_ENDED, DIRECT_PARITY_LINK_NONE, 0u, 0u, 0u, "" }
};
...
const DirectParityScenario direct_parity_restore_guest_local_active = {
    "restore-guest-local-active",
    restore_guest_local_active_steps,
    restore_guest_local_active_expected,
    (uint8_t)(sizeof(restore_guest_local_active_steps) /
              sizeof(restore_guest_local_active_steps[0])),
    (uint8_t)(sizeof(restore_guest_local_active_expected) /
              sizeof(restore_guest_local_active_expected[0])),
    DIRECT_PARITY_ROLE_GUEST,
    DIRECT_PARITY_COLOR_WHITE
};
...
static const uint8_t restore_rs00_invalid[] =
    "RS00 !AAAAAAAAAAAAAAAAAEgAAACEAAAAA";
...
static const uint8_t legacy_draw_payload[] = "DRAW";
static const uint8_t legacy_ack_draw_payload[] = "ACK DRAW";
static const uint8_t legacy_nack_draw_plain_payload[] = "NACK DRAW";
static const uint8_t legacy_nack_draw_payload[] = "NACK DRAW BUSY";
static const uint8_t legacy_cancel_draw_payload[] = "CANCEL DRAW";
static const uint8_t reset_payload[] = "RESET";

static const DirectParityStep unsupported_draw_guest_steps[] = {
    { 0, DIRECT_PARITY_IN_LINK_UP, 1u, 0u, 0u, 0u, 0u },
    { guest_smoke_hello, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(guest_smoke_hello) - 1u), 0u, 0u, 0u },
    { remote_start, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(remote_start) - 1u), 0u, 0u, 0u },
    { 0, DIRECT_PARITY_IN_TIMEOUT, 1u, 0u, 100u, 0u, 0u },
    { legacy_draw_payload, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(legacy_draw_payload) - 1u), 0u, 0u, 0u },
    { legacy_ack_draw_payload, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(legacy_ack_draw_payload) - 1u), 0u, 0u, 0u },
    { legacy_nack_draw_plain_payload, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(legacy_nack_draw_plain_payload) - 1u),
      0u, 0u, 0u },
    { legacy_nack_draw_payload, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(legacy_nack_draw_payload) - 1u), 0u, 0u, 0u },
    { legacy_cancel_draw_payload, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(legacy_cancel_draw_payload) - 1u), 0u, 0u, 0u },
    { 0, DIRECT_PARITY_IN_TIMEOUT, 1u, 0u, 50u, 0u, 0u },
    { 0, DIRECT_PARITY_IN_LINK_DOWN, 1u, 0u, 0u, 0u, 0u }
};

static const DirectParityObservation unsupported_draw_guest_expected[] = {
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 18u, 0u,
      "HELLO DIRECT GUEST" },
    { DIRECT_PARITY_OBS_SIDE, DIRECT_PARITY_LINK_NONE,
      DIRECT_PARITY_COLOR_BLACK, 0u, 0u, "" },
...
const DirectParityScenario direct_parity_unsupported_draw = {
    "unsupported-draw-guest",
    unsupported_draw_guest_steps,
    unsupported_draw_guest_expected,
    (uint8_t)(sizeof(unsupported_draw_guest_steps) /
              sizeof(unsupported_draw_guest_steps[0])),
    (uint8_t)(sizeof(unsupported_draw_guest_expected) /
              sizeof(unsupported_draw_guest_expected[0])),
    DIRECT_PARITY_ROLE_GUEST,
    DIRECT_PARITY_COLOR_WHITE
};
...
static const DirectParityObservation move_pending_controls_busy_expected[] = {
    ...
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 22u, 0u,
      "GAME START WHITE=GUEST" },
    { DIRECT_PARITY_OBS_STARTED, DIRECT_PARITY_LINK_NONE, 0u, 0u, 0u, "" },
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 9u, 0u, "MOVE 1 d3" },
    { DIRECT_PARITY_OBS_SEND, 1u, 0u, 15u, 0u, "NACK RESET BUSY" },
...
static const uint8_t pending_control_chat[] = "hello";
...
static const DirectParityStep resign_crossed_steps[] = {
    ...
    { 0, DIRECT_PARITY_IN_LOCAL, 1u, 0u, 0u,
      DIRECT_PARITY_REQUEST_RESIGN, 0u },
    { pending_control_chat, DIRECT_PARITY_IN_LOCAL, 1u,
      (uint8_t)(sizeof(pending_control_chat) - 1u), 0u,
      DIRECT_PARITY_REQUEST_CHAT, 0u },
    { resign_payload, DIRECT_PARITY_IN_RX, 1u,
      (uint8_t)(sizeof(resign_payload) - 1u), 0u, 0u, 0u },
    { reset_payload, DIRECT_PARITY_IN_RX, 1u,
...
const DirectParityScenario *const direct_parity_scenarios[] = {
    &direct_parity_host_smoke,
    &direct_parity_chat_rearms_liveness,
    &direct_parity_chat_send_fail,
    ...
    &direct_parity_restore_guest_local_active,
    ...
    &direct_parity_unsupported_draw,
...
const uint8_t direct_parity_scenario_count =
    (uint8_t)(sizeof(direct_parity_scenarios) /
              sizeof(direct_parity_scenarios[0]));
