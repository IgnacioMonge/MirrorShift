...
typedef enum netchesszx_session_event {
    ...
    /* 6 was the removed negotiated-DRAW ACK. Overlay event IDs stay stable. */
    NETCHESSZX_SESSION_EVENT_ACK_GAME_START = 7,
    NETCHESSZX_SESSION_EVENT_ACK_RESIGN,
    NETCHESSZX_SESSION_EVENT_NACK_MOVE,
    NETCHESSZX_SESSION_EVENT_NACK_RESET,
    /* 11 was the removed negotiated-DRAW NACK. */
    NETCHESSZX_SESSION_EVENT_NACK_GAME_START = 12,
    NETCHESSZX_SESSION_EVENT_BYE,
    NETCHESSZX_SESSION_EVENT_RESET,
    /* 15 was the removed negotiated-DRAW request. */
    NETCHESSZX_SESSION_EVENT_CANCEL_RESET = 16,
    /* 17 was the removed negotiated-DRAW cancellation. */
    NETCHESSZX_SESSION_EVENT_RESIGN = 18,
    ...
    /* Removed untyped MQTT text fallback; machine event IDs stay fixed. */
...
#define NETCHESSZX_SESSION_MQTT_HOST_SESSION_CHANGED 0x20u
