...
#error "Mirror Shift Spectrum overlays must be built with the SDCC/IY ABI."
#endif
...
#define SPECTRUM_OVL_BLOCK_SIZE 4096u
#else
...
void spectrum_gui_edit_show(uint16_t row_col) __z88dk_fastcall;
...
#ifdef NETCHESSZX_SPECTRANEXT
uint8_t spectrum_gui_shift_clock(int8_t hour_delta) __z88dk_fastcall;
#endif
