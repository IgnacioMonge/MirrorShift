...
#define SPECTRUM_OVL_RULES_RESTORE_VALIDATE 4u
...
/* Preserve cartridge TIME=17; append notices after the platform's old IDs. */
#ifdef NETCHESSZX_SPECTRANEXT
#define SPECTRUM_OVL_NOTICES 18u
#else
#define SPECTRUM_OVL_NOTICES 17u
#endif
#define SPECTRUM_OVL_NOTICES_NOTIFY 0u
