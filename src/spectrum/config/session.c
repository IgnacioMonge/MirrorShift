...
#define NETCHESSZX_DEFAULT_COLOR NETCHESSZX_COLOR_BLACK
...
uint8_t netchesszx_piece_set_index = NETCHESSZX_PIECE_SET_BW_L;
                                  ...
                                  uint8_t host_color)
{
    ...
    if (host_color != NETCHESSZX_COLOR_WHITE) {
        host_color = NETCHESSZX_COLOR_BLACK;
    }
    ...
    netchesszx_host_color_ready =
        (uint8_t)(role == NETCHESSZX_SESSION_ROLE_HOST);
}
