...
#define SPECTRUM_GUI_TURN_SELF 0u
#define SPECTRUM_GUI_TURN_ECHO 1u
#define SPECTRUM_GUI_TURN_SELF_SILENCE 2u
#define SPECTRUM_GUI_TURN_ECHO_SILENCE 3u
#define SPECTRUM_GUI_TURN_CLEAR 4u
#define SPECTRUM_GUI_TURN_MARKER_CLEAR 5u
#define SPECTRUM_GUI_TURN_MARKER_WHITE 0x80u
...
void spectrum_gui_edit_show(uint16_t row_col) NETCHESSZX_FASTCALL;
void spectrum_gui_edit_hide(void);
