...
/* Runtime assets and network scratch stay outside executable overlay pages.
   Next uses permanent slot 1; Classic keeps the original low-RAM layout. */
#ifdef NETCHESSZX_NEXT_BANKING
#define SPECTRUM_MQTT_RUNTIME_ASSETS_END 0x383cu
#define SPECTRUM_MQTT_SCRATCH_BASE 0x3a8bu
#else
#define SPECTRUM_MQTT_RUNTIME_ASSETS_END 0x633cu
