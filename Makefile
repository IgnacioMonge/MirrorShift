...
MQTT_STREAM_TEST_CFLAGS :=
# MinGW resolves PE/COFF references before --gc-sections; internalize the
# included net.c first so only the parser exercised by this test survives.
ifneq ($(CLIENT_HOST_IS_WINDOWS),)
MQTT_STREAM_TEST_CFLAGS := -O1 -fwhole-program
endif
...
ZX_ORG := 28672
CHECKER_PNGS := assets/editable/checkers/BW-S/reality-a.png \
                assets/editable/checkers/BW-S/reality-b.png \
                assets/editable/checkers/BW-M/reality-a.png \
                assets/editable/checkers/BW-M/reality-b.png \
                assets/editable/checkers/BW-L/reality-a.png \
                assets/editable/checkers/BW-L/reality-b.png
CHECKER_REFLECTION_PNGS := $(wildcard assets/editable/checkers/BW-*/reflection/*.png)
...
SPECTRUM_SRC := src/spectrum/app/app.c \
                ...
                src/spectrum/board/reversi_board.c \
...
PIECE_ASM := assets/spectrum/checker_pieces_16x16.asm
REFLECTION_BIN := assets/spectrum/checker_reflections.bin
CURSOR_PNG := assets/editable/cursor.png
SPECTRUM_HEADERS := $(shell find src/common src/spectrum -name '*.h' -print) src/common/reversi/reversi_restore.inc

REVERSI_TEST := $(BUILD_DIR)/mirrorshift_reversi_test.exe
REVERSI_TEST_SRC := src/common/reversi/reversi.c tests/rules/test_reversi.c
REVERSI_BOARD_RESTORE_TEST := $(BUILD_DIR)/mirrorshift_reversi_board_restore_test.exe
REVERSI_BOARD_RESTORE_TEST_SRC := src/common/reversi/reversi.c src/spectrum/board/reversi_board.c tests/spectrum/test_reversi_board_restore.c
SAVEGAME_WIRE_TEST := $(BUILD_DIR)/mirrorshift_savegame_wire_test.exe
...
MQTT_TEST := $(BUILD_DIR)/mirrorshift_mqtt_test.exe
MQTT_TEST_SRC := src/common/mqtt/mqtt.c src/spectrum/transport/mqtt_min.c \
                 tests/net/test_mqtt.c
MQTT_STREAM_TEST := $(BUILD_DIR)/mirrorshift_mqtt_stream_test.exe
MQTT_STREAM_TEST_SRC := tests/spectrum/test_mqtt_stream.c
GAME_PROTOCOL_TEST := $(BUILD_DIR)/mirrorshift_game_protocol_test.exe
...
ESP_AT_TEST := $(BUILD_DIR)/mirrorshift_esp_at_test.exe
ESP_AT_NEXT_TEST := $(BUILD_DIR)/mirrorshift_esp_at_next_test.exe
ESP_AT_TEST_SRC := src/spectrum/transport/esp_at.c src/common/protocol/game_protocol.c tests/net/test_esp_at.c
UART_PLATFORM_TEST := $(BUILD_DIR)/mirrorshift_uart_platform_test.exe
UART_PLATFORM_NEXT_TEST := $(BUILD_DIR)/mirrorshift_uart_platform_next_test.exe
MQTT_STREAM_NEXT_TEST := $(BUILD_DIR)/mirrorshift_mqtt_stream_next_test.exe
UART_PLATFORM_TEST_SRC := src/spectrum/platform/platform.c tests/spectrum/test_uart_platform.c
NET_RUNTIME_TEST := $(BUILD_DIR)/mirrorshift_net_runtime_test.exe
NET_RUNTIME_TEST_SRC := src/spectrum/app/net_runtime.c tests/spectrum/test_net_runtime.c
DIRECT_IPD_TEST := $(BUILD_DIR)/mirrorshift_direct_ipd_test.exe
DIRECT_IPD_TEST_SRC := tests/spectrum/test_direct_ipd.c \
                       tests/spectrum/text_asm_host.c
SPECTRANEXT_DIRECT_TEST := $(BUILD_DIR)/mirrorshift_spectranext_direct_test.exe
SPECTRANEXT_DIRECT_TEST_SRC := tests/spectrum/test_spectranext_direct.c
MQTT_SESSION_PROTOCOL_TEST := $(BUILD_DIR)/mirrorshift_mqtt_session_protocol_test.exe
...
DIRECT_SESSION_PROTOCOL_TEST := $(BUILD_DIR)/mirrorshift_direct_session_protocol_test.exe
DIRECT_SESSION_PROTOCOL_TEST_SRC := src/common/protocol/direct_session_protocol.c \
                                    src/common/protocol/game_protocol.c \
                                    tests/net/test_direct_session_protocol.c
SESSION_CORE_TEST := $(BUILD_DIR)/mirrorshift_session_core_test.exe
...
SESSION_DIRECT_CORE_TEST := $(BUILD_DIR)/mirrorshift_session_direct_core_test.exe
...
SESSION_MQTT_PARITY_TEST := $(BUILD_DIR)/mirrorshift_mqtt_session_parity_test.exe
SESSION_MQTT_PARITY_TEST_SRC := src/common/session/session.c \
                                  ...
                                  src/spectrum/overlay/restore_ovl.c \
                                  src/spectrum/board/reversi_board.c
SESSION_DIRECT_PARITY_TEST := $(BUILD_DIR)/mirrorshift_direct_session_parity_test.exe
SESSION_DIRECT_PARITY_NEXT_TEST := $(BUILD_DIR)/mirrorshift_direct_session_parity_next_test.exe
SESSION_DIRECT_PARITY_SPECTRANEXT_TEST := $(BUILD_DIR)/mirrorshift_direct_session_parity_spectranext_test.exe
SESSION_DIRECT_PARITY_TEST_SRC := tests/session/test_direct_session_parity.c \
                                  ...
                                  src/spectrum/overlay/restore_ovl.c \
                                  src/spectrum/board/reversi_board.c
KEEPALIVE_PROTOCOL_TEST := $(BUILD_DIR)/mirrorshift_keepalive_protocol_test.exe
KEEPALIVE_PROTOCOL_TEST_SRC := src/spectrum/transport/keepalive_protocol.c \
                               src/common/protocol/game_protocol.c \
                               tests/net/test_keepalive_protocol.c
SESSION_CONFIG_TEST := $(BUILD_DIR)/mirrorshift_session_config_test.exe
SESSION_CONFIG_TEST_SRC := src/spectrum/config/session.c \
                           src/common/protocol/game_protocol.c \
                           tests/spectrum/test_session_config.c
APP_CONFIG_FORMAT_TEST := $(BUILD_DIR)/mirrorshift_app_config_format_test.exe
APP_CONFIG_FORMAT_TEST_SRC := tests/spectrum/test_app_config_format.c
CONFIG_OVERLAY_TEST := $(BUILD_DIR)/mirrorshift_config_overlay_test.exe
CONFIG_OVERLAY_NEXT_TEST := $(BUILD_DIR)/mirrorshift_config_overlay_next_test.exe
CONFIG_OVERLAY_XFS_TEST := $(BUILD_DIR)/mirrorshift_config_overlay_xfs_test.exe
CONFIG_OVERLAY_TEST_SRC := tests/spectrum/test_config_overlay.c \
                           src/spectrum/config/session.c \
                           src/common/protocol/game_protocol.c
SESSION_PING_TEST := $(BUILD_DIR)/mirrorshift_session_ping_test.exe
SESSION_PING_TEST_SRC := src/spectrum/session/ping.c tests/spectrum/test_session_ping.c
SESSION_PING_NEXT_TEST := $(BUILD_DIR)/mirrorshift_session_ping_next_test.exe
SESSION_PING_SPECTRANEXT_TEST := $(BUILD_DIR)/mirrorshift_session_ping_spectranext_test.exe
SESSION_POLL_TEST := $(BUILD_DIR)/mirrorshift_session_poll_test.exe
SESSION_POLL_SPECTRANEXT_TEST := $(BUILD_DIR)/mirrorshift_session_poll_spectranext_test.exe
...
SESSION_DIRECT_TEST := $(BUILD_DIR)/mirrorshift_session_direct_test.exe
SESSION_DIRECT_TEST_SRC := src/spectrum/config/session.c \
                            src/common/protocol/direct_session_protocol.c \
                            src/common/protocol/game_protocol.c \
                            src/spectrum/session/direct.c \
                            tests/spectrum/test_session_direct.c
SESSION_EVENT_TEST := $(BUILD_DIR)/mirrorshift_session_event_test.exe
...
SESSION_MQTT_TEST := $(BUILD_DIR)/mirrorshift_session_mqtt_test.exe
SESSION_MQTT_TEST_SRC := src/spectrum/config/session.c \
                         src/common/protocol/game_protocol.c \
                         src/common/protocol/mqtt_session_protocol.c \
                         src/spectrum/session/mqtt.c \
                         tests/spectrum/test_session_mqtt.c
SESSION_SPECTRUM_PAIR_TEST := $(BUILD_DIR)/mirrorshift_session_spectrum_pair_test.exe
...
SESSION_OUTGOING_TEST := $(BUILD_DIR)/mirrorshift_session_outgoing_test.exe
SESSION_OUTGOING_TEST_SRC := src/common/protocol/game_protocol.c \
                             src/spectrum/config/session.c \
                             src/spectrum/session/outgoing.c \
                             tests/spectrum/text_asm_host.c \
                             tests/spectrum/test_session_outgoing.c
GUI_LOG_TEST := $(BUILD_DIR)/mirrorshift_gui_log_test.exe
GUI_LOG_TEST_SRC := tests/spectrum/test_gui_log.c
NOTICES_TEST := $(BUILD_DIR)/mirrorshift_notices_test.exe
GUI_TIMER_TEST := $(BUILD_DIR)/mirrorshift_gui_timer_test.exe
GUI_TIMER_TEST_SRC := tests/spectrum/test_gui_timer.c
STATUS_OVERLAY_TEST := $(BUILD_DIR)/mirrorshift_status_overlay_test.exe
STATUS_OVERLAY_TEST_SRC := tests/spectrum/test_status_overlay.c
FAT_TIMEZONE_TEST := $(BUILD_DIR)/mirrorshift_fat_timezone_test.exe
FAT_TIMEZONE_TEST_SRC := tests/spectrum/test_fat_timezone.c
FILEUI_PAGING_TEST := $(BUILD_DIR)/mirrorshift_fileui_paging_test.exe
SAVELOAD_XFS_TEST := $(BUILD_DIR)/mirrorshift_saveload_xfs_test.exe
SAVELOAD_ESXDOS_TEST := $(BUILD_DIR)/mirrorshift_saveload_esxdos_test.exe
...
ifeq ($(filter divmmc next,$(UART_BACKEND)),)
...
ATLAS_BINDING_ARGS :=
ATLAS_BINDING_DEPS :=
OVERLAY_ATLAS_FLAGS := --extra NOTICES
...
ifeq ($(UART_BACKEND),next)
$(error NET_BACKEND=spectranext cannot use UART_BACKEND=next)
endif
ifneq ($(FS_BACKEND),xfs)
$(error NET_BACKEND=spectranext requires FS_BACKEND=xfs)
endif
SPXN_C_SRCS += $(SPXN_DIR_ABS)/spxn.c
SPXN_C_SRCS += $(SPXN_DIR_ABS)/spxn_stream.c
SPXN_RESOLVE_C := $(SPXN_DIR_ABS)/spxresolve.c
SPECTRUM_SRC += src/spectrum/transport/spectranext_direct_stage.c
SPXN_ASMS += $(SPXN_DIR_ABS)/spxn_rom.asm
SPXN_ASMS += asm/esxdos/xfs_loader_spectranext.asm
SPXN_RESIDENT_OBJS := $(BUILD_DIR)/spxn.o $(BUILD_DIR)/spxn_stream.o $(BUILD_DIR)/spxn_rom.o $(BUILD_DIR)/xfs_loader_spectranext.o
SPXN_UDP_SRC := $(SPXN_DIR_ABS)/spxudp.c
SPXN_TIME_SRC := $(SPXN_DIR_ABS)/spxtime.c
SPXN_OVERLAY_SRC := asm/overlay/time/entry_time.asm \
                    src/spectrum/overlay/time_ovl.c \
                    $(SPXN_UDP_SRC) \
                    $(SPXN_TIME_SRC)
SPECTRUM_SRC := $(filter-out src/spectrum/transport/esp_at.c,$(SPECTRUM_SRC))
UART_ASM :=
OVERLAY_ATLAS_FLAGS := --extra TIME --extra NOTICES
ZX_TARGET_CFLAGS += -DNETCHESSZX_SPECTRANEXT -I$(SPXN_DIR_ABS) -pragma-define:REGISTER_SP=0
endif

ifeq ($(FS_BACKEND),xfs)
SPXN_ATOMIC_SRC := $(SPXN_DIR_ABS)/spxf_replace.asm
SPXN_ATOMIC_OBJ := $(BUILD_DIR)/spxf_replace_ovl.o
SPXN_OVERLAY_SRC += $(SPXN_ATOMIC_SRC)
SPXN_XFS_OVERLAY_ASM := $(BUILD_DIR)/xfs_compat.asm
SPXN_OVERLAY_SRC += $(SPXN_XFS_OVERLAY_ASM) $(SPXN_RESOLVE_C) $(wildcard $(SPXN_DIR_ABS)/*.h)
ESX_COMMON_ASM :=
ESX_FILEUI_ASM :=
ESX_SAVELOAD_ASM :=
ESX_FILEUI_OBJ :=
ESX_SAVELOAD_OBJ :=
ZX_TARGET_CFLAGS += -DNETCHESSZX_FS_XFS -I$(SPXN_DIR_ABS)
ATLAS_BINDING_DEPS := $(SPECTRUM_SRC) $(SPECTRUM_HEADERS) $(SPXN_C_SRCS) $(SPXN_ASMS) $(SPXN_RESOLVE_C) $(SPXN_UDP_SRC) $(SPXN_TIME_SRC) $(SPXN_ATOMIC_SRC) $(SPXN_DIR_ABS)/adapters/xfs_compat.asm $(wildcard $(SPXN_DIR_ABS)/*.h) Makefile
ATLAS_BINDING_ARGS = --binding-path src/common --binding-path src/spectrum --binding-path asm --binding-path Makefile --binding-path tools/build_overlays.py --binding-path tools/gen_overlay_atlas.py --binding-path tools/gen_overlay_defs.py --binding-path tools/mirrorshift_bool_copt --binding-path $(BUILD_CONFIG_STAMP) $(foreach path,$(SPXN_C_SRCS) $(SPXN_ASMS) $(SPXN_RESOLVE_C) $(SPXN_UDP_SRC) $(SPXN_TIME_SRC) $(SPXN_ATOMIC_SRC) $(SPXN_DIR_ABS)/adapters/xfs_compat.asm $(wildcard $(SPXN_DIR_ABS)/*.h),--binding-path $(path))
endif
...
NEXT_EXTENSION_INCLUDES := asm/next/screen_extension_stubs_top.asm asm/next/screen_extension_stubs_tail.asm
...
NEXT_SIZE_BASELINE := docs/size_report.next.baseline.json
...
NEXT_GRAPHICS_BANK_BIN := $(NEXT_NEX_BUILD_DIR)/MIRSHIFT_EXTENSION.BIN
...
NEXT_SPRITE_BIN := assets/next/checker_piece_sprites.bin
NEXT_SPRITE_PAL_BIN := assets/next/checker_sprite_palette.bin
NEXT_SPRITE_META := assets/next/checker_piece_sprites.json
NEXT_EDITABLE_ROOT := assets/editable/next
NEXT_SPRITE_SOURCE_PNGS := $(shell find $(NEXT_EDITABLE_ROOT)/boards \
                                           $(NEXT_EDITABLE_ROOT)/markers \
                                           $(NEXT_EDITABLE_ROOT)/pieces \
                                           -type f -name '*.png' 2>/dev/null)
NEXT_SPRITE_OFFSET := 16384
NEXT_SPRITE_PAL_OFFSET := 32768
NEXT_ABOUT_NXI := assets/next/about_screen.nxi
NEXT_ABOUT_PNG := $(NEXT_EDITABLE_ROOT)/about.png
...
ifeq ($(NET_BACKEND),spectranext)
ZX_ASMFLAGS += -DNETCHESSZX_SPECTRANEXT -DSPXN_ROM_HELD -DSPXN_ROM_HELD_EXTERNAL
endif
ifeq ($(FS_BACKEND),xfs)
ZX_ASMFLAGS += -DNETCHESSZX_FS_XFS \
		       -DSPXN_XFS_STATE_BASE=0x5B60 \
		       -DSPXN_XFS_DIR_SCRATCH=0x662B \
		       -DSPXN_XFS_SCRATCH_PRESERVE_BASE=0x662B \
		       -DSPXN_XFS_SCRATCH_PRESERVE_SIZE=96 \
		       -DSPXN_XFS_SCRATCH_PRESERVE_BACKUP=0x676B
endif
...
ZX_CFLAGS := -vn -startup=31 -clib=$(ZX_CLIB) -SO3 -m \
             -custom-copt-rules=$(BUILD_DIR_UP)tools/mirrorshift_bool_copt \
             $(ZX_SDCC_CFLAGS) \
...
SPXN_TIME_OVL_CFLAGS := --opt-code-size \
...
NEXT_NEX_INPUTS := Makefile $(SPECTRUM_SRC) src/common/reversi/reversi.c \
                   $(SPECTRUM_HEADERS) $(OVERLAY_SRC) $(SHRINK_ASM) \
                   $(EDIT_FIELD_ASM) asm/spectrum/screen.asm asm/spectrum/input_queue.asm \
                   asm/spectrum/text.asm $(NEXT_OVERLAY_LOADER_ASM) \
                   asm/uart/next_uart.asm tools/mirrorshift_bool_copt \
                   tools/check_sdcc_iy_contract.py tools/check_tap_image.py \
                   tools/build_overlays.py tools/gen_overlay_defs.py tools/gen_overlay_atlas.py \
                   tools/gen_assets.py $(ATLAS_SEED_FILE) $(ASSET_ASM) \
                   $(PIECE_ASM) $(ABOUT_BOARD) VERSION

.NOTPARALLEL:

.PHONY: all check full-check module-guards layering-check layering-report overlay-cap-check overlay-cap-report overlay-entry-abi-check transport-contract-check mqtt-client-id-check pc-direct-policy-check pc-policy-guard spectrum-direct-policy-check session-boundaries-check test gui-log-test gui-timer-test status-overlay-test session-core-test session-mqtt-parity-test session-direct-core-test session-direct-parity-test spectranext-direct-test spectranext-conformance-test session-spectrum-pair-test tap tap-direct-overlay tap-divmmc tap-spectranext spectranext-resource next nex nex-size-report nex-size-baseline sdcc-iy-contract-check abi-manifest abi-next-manifest abi-baseline abi-next-baseline abi-check abi-next-check size-report size-baseline size-check literal-report client qt-client pc-client mac-client client-msvc client-cmake clean clean-spectrum clean-client FORCE
...
$(SESSION_MQTT_PARITY_TEST) $(SESSION_DIRECT_PARITY_TEST) $(SESSION_DIRECT_PARITY_NEXT_TEST): src/common/reversi/reversi_restore.inc

$(REVERSI_BOARD_RESTORE_TEST): $(REVERSI_BOARD_RESTORE_TEST_SRC) src/common/reversi/reversi.h src/common/reversi/reversi_restore.inc | $(BUILD_DIR)
	$(CC) $(CFLAGS) -DNETCHESSZX_HOST_TEST $(REVERSI_BOARD_RESTORE_TEST_SRC) -o $@

$(REVERSI_TEST): $(REVERSI_TEST_SRC) src/common/reversi/reversi.h src/common/reversi/reversi_restore.inc | $(BUILD_DIR)
	$(CC) $(CFLAGS) $(REVERSI_TEST_SRC) -o $@
...
$(MQTT_STREAM_TEST): $(MQTT_STREAM_TEST_SRC) src/spectrum/transport/net.c | $(BUILD_DIR)
	$(CC) $(CFLAGS) -Wno-pointer-to-int-cast -DNETCHESSZX_HOST_TEST -D__z88dk_fastcall= \
		$(MQTT_STREAM_TEST_CFLAGS) $(HOST_GC_CFLAGS) $(MQTT_STREAM_TEST_SRC) $(HOST_GC_LDFLAGS) -o $@

$(MQTT_STREAM_NEXT_TEST): $(MQTT_STREAM_TEST_SRC) src/spectrum/transport/net.c | $(BUILD_DIR)
	$(CC) $(CFLAGS) -Wno-pointer-to-int-cast -DNETCHESSZX_HOST_TEST -DNETCHESSZX_NEXT -D__z88dk_fastcall= \
		$(MQTT_STREAM_TEST_CFLAGS) $(HOST_GC_CFLAGS) $(MQTT_STREAM_TEST_SRC) $(HOST_GC_LDFLAGS) -o $@

.PHONY: spectranext-mqtt-stream-test input-queue-test overlay-builder-test
spectranext-mqtt-stream-test: $(BUILD_DIR)/mirrorshift_mqtt_stream_spectranext_test.exe
	./$<

$(BUILD_DIR)/mirrorshift_mqtt_stream_spectranext_test.exe: $(MQTT_STREAM_TEST_SRC) src/spectrum/transport/net.c $(wildcard $(SPXN_DIR)/*.h) | $(BUILD_DIR)
	@test -f "$(SPXN_DIR)/spxn.h" || { echo "[ERR] Set SPXN_DIR to the SpectraNext driver directory"; exit 1; }
	$(CC) $(CFLAGS) -I"$(SPXN_DIR)" -Wno-pointer-to-int-cast -DNETCHESSZX_HOST_TEST \
		-DNETCHESSZX_SPECTRANEXT -DSPXN_HOST -D__z88dk_fastcall= \
		$(MQTT_STREAM_TEST_CFLAGS) $(HOST_GC_CFLAGS) $(MQTT_STREAM_TEST_SRC) $(HOST_GC_LDFLAGS) -o $@

input-queue-test:
	"$(PYTHON)" tests/tools/test_input_queue.py --root . --build-dir $(BUILD_DIR)

overlay-builder-test:
	"$(PYTHON)" tests/tools/test_build_overlays.py
	"$(PYTHON)" tests/tools/test_overlay_atlas_layout.py
	"$(PYTHON)" tests/spectrum/test_next_runtime_contract.py
	"$(PYTHON)" tests/spectrum/test_next_runtime_lowmem.py
	"$(PYTHON)" tests/tools/test_next_esxdos_mapping.py

test: input-queue-test overlay-builder-test
ifneq ($(strip $(SPXN_DIR)),)
test: spectranext-mqtt-stream-test
endif

.PHONY: mqtt-tx-time-test
mqtt-tx-time-test: $(BUILD_DIR)/mirrorshift_mqtt_tx_time_test.exe
	./$<

$(BUILD_DIR)/mirrorshift_mqtt_tx_time_test.exe: tests/spectrum/test_mqtt_tx_time.c src/spectrum/overlay/mqtt_tx_ovl.c $(SPECTRUM_HEADERS) | $(BUILD_DIR)
	$(CC) $(CFLAGS) -Wno-int-to-pointer-cast -DNETCHESSZX_HOST_TEST -D__z88dk_fastcall= $< -o $@

test: mqtt-tx-time-test
...
$(UART_PLATFORM_NEXT_TEST): $(UART_PLATFORM_TEST_SRC) src/spectrum/platform/uart.h src/spectrum/lowram_map.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) -DNETCHESSZX_HOST_TEST -DNETCHESSZX_NEXT $(UART_PLATFORM_TEST_SRC) -o $@

test: $(UART_PLATFORM_NEXT_TEST) $(MQTT_STREAM_NEXT_TEST)

$(NET_RUNTIME_TEST): $(NET_RUNTIME_TEST_SRC) src/spectrum/platform/net_runtime.h src/spectrum/transport/fat_calendar.h src/spectrum/transport/fat_clock.h \
                     src/spectrum/platform/platform.h src/spectrum/transport/link.h \
                     src/spectrum/ui/gui.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) $(NET_RUNTIME_TEST_SRC) -o $@
...
$(SPECTRANEXT_DIRECT_TEST): $(SPECTRANEXT_DIRECT_TEST_SRC) src/spectrum/overlay/direct_ovl.c src/spectrum/transport/spectranext_direct_stage.c src/spectrum/overlay/overlay_api.h src/spectrum/transport/net.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) $(SPECTRANEXT_DIRECT_TEST_SRC) -o $@

spectranext-direct-test: $(SPECTRANEXT_DIRECT_TEST)
	./$(SPECTRANEXT_DIRECT_TEST)

spectranext-conformance-test: $(BUILD_DIR)/mirrorshift_spectranext_time_shift_test.exe $(SPECTRANEXT_DIRECT_TEST) $(SESSION_PING_SPECTRANEXT_TEST) $(SESSION_POLL_SPECTRANEXT_TEST) $(SESSION_DIRECT_PARITY_SPECTRANEXT_TEST) tests/tools/test_spcx_direct_conformance.py
	./$(BUILD_DIR)/mirrorshift_spectranext_time_shift_test.exe
	./$(SPECTRANEXT_DIRECT_TEST)
...
$(SESSION_MQTT_PARITY_TEST): $(SESSION_MQTT_PARITY_TEST_SRC) tests/session/mqtt_session_transcripts.h src/spectrum/app/app.c src/spectrum/session/timing.h | $(BUILD_DIR)
...
$(SESSION_DIRECT_PARITY_TEST): $(SESSION_DIRECT_PARITY_TEST_SRC) tests/session/direct_parity.h src/spectrum/app/app.c src/spectrum/session/timing.h src/spectrum/overlay/direct_ovl.c | $(BUILD_DIR)
	$(CC) $(CFLAGS) -DNETCHESSZX_HOST_TEST -DNETCHESSZX_HOST_SESSION_TEST \
		-D__z88dk_fastcall= $(HOST_GC_CFLAGS) \
		$(SESSION_DIRECT_PARITY_TEST_SRC) $(HOST_GC_LDFLAGS) -o $@

$(SESSION_DIRECT_PARITY_NEXT_TEST): $(SESSION_DIRECT_PARITY_TEST_SRC) tests/session/direct_parity.h src/spectrum/app/app.c src/spectrum/session/timing.h src/spectrum/overlay/direct_ovl.c | $(BUILD_DIR)
	$(CC) $(CFLAGS) -DNETCHESSZX_HOST_TEST -DNETCHESSZX_HOST_SESSION_TEST \
		-DNETCHESSZX_NEXT -DNETCHESSZX_NEXT_BANKING \
		-D__z88dk_fastcall= $(HOST_GC_CFLAGS) \
		$(SESSION_DIRECT_PARITY_TEST_SRC) $(HOST_GC_LDFLAGS) -o $@

$(SESSION_DIRECT_PARITY_SPECTRANEXT_TEST): $(SESSION_DIRECT_PARITY_TEST_SRC) tests/session/direct_parity.h src/spectrum/app/app.c src/spectrum/session/timing.h src/spectrum/overlay/direct_ovl.c | $(BUILD_DIR)
	$(CC) $(CFLAGS) -DNETCHESSZX_HOST_TEST -DNETCHESSZX_HOST_SESSION_TEST \
...
$(CONFIG_OVERLAY_NEXT_TEST): $(CONFIG_OVERLAY_TEST_SRC) src/spectrum/overlay/config_ovl.c src/spectrum/config/app_config_format.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) -DNETCHESSZX_NEXT $(CONFIG_OVERLAY_TEST_SRC) -o $@

$(CONFIG_OVERLAY_XFS_TEST): $(CONFIG_OVERLAY_TEST_SRC) src/spectrum/overlay/config_ovl.c src/spectrum/config/app_config_format.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) -DNETCHESSZX_SPECTRANEXT $(CONFIG_OVERLAY_TEST_SRC) -o $@

$(SAVELOAD_XFS_TEST): tests/spectrum/test_saveload_xfs.c src/spectrum/overlay/saveload_ovl.c | $(BUILD_DIR) \
                        src/spectrum/transport/fat_clock.h src/spectrum/transport/fat_calendar.h
	$(CC) $(CFLAGS) -Wno-pointer-to-int-cast -Wno-int-to-pointer-cast -Wno-sign-compare -DNETCHESSZX_HOST_TEST -DNETCHESSZX_SPECTRANEXT -D__z88dk_fastcall= tests/spectrum/test_saveload_xfs.c src/spectrum/overlay/saveload_ovl.c -o $@

$(SAVELOAD_ESXDOS_TEST): tests/spectrum/test_saveload_esxdos.c src/spectrum/overlay/saveload_ovl.c | $(BUILD_DIR) \
                        src/spectrum/transport/fat_clock.h src/spectrum/transport/fat_calendar.h
	$(CC) $(CFLAGS) -Wno-pointer-to-int-cast -Wno-int-to-pointer-cast -Wno-sign-compare tests/spectrum/test_saveload_esxdos.c -o $@
...
$(BUILD_DIR)/mirrorshift_spectranext_time_shift_test.exe: tests/spectrum/test_spectranext_time_shift.c src/spectrum/overlay/time_ovl.c $(SPECTRUM_HEADERS) | $(BUILD_DIR)
	$(CC) $(CFLAGS) -Wno-unused-function -I$(SPXN_DIR) -DNETCHESSZX_HOST_TEST -DNETCHESSZX_SPECTRANEXT -DSPXN_HOST -D__z88dk_fastcall= tests/spectrum/test_spectranext_time_shift.c -o $@

$(NOTICES_TEST): tests/spectrum/test_notices.c src/spectrum/overlay/notices_ovl.c src/common/ui_messages.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) tests/spectrum/test_notices.c -o $@
...
$(GUI_TIMER_TEST): $(GUI_TIMER_TEST_SRC) src/spectrum/ui/timer.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) -DNETCHESSZX_HOST_TEST -D__z88dk_fastcall= \
		-D__z88dk_callee= -Wno-int-to-pointer-cast \
		$(HOST_GC_CFLAGS) $(GUI_TIMER_TEST_SRC) $(HOST_GC_LDFLAGS) -o $@
...
$(FAT_TIMEZONE_TEST): $(FAT_TIMEZONE_TEST_SRC) src/spectrum/transport/fat_timezone.h src/spectrum/transport/fat_calendar.h src/spectrum/transport/fat_clock.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) $(FAT_TIMEZONE_TEST_SRC) -o $@

$(FILEUI_PAGING_TEST): tests/spectrum/test_fileui_paging.c src/spectrum/overlay/fileui_ovl.c | $(BUILD_DIR)
	$(CC) $(CFLAGS) -Wno-int-to-pointer-cast tests/spectrum/test_fileui_paging.c -o $@
...
check: module-guards | $(BUILD_DIR) $(RELEASE_DIR)
	@mqtt_host='$(MQTT_HOST)'; if [ "$${#mqtt_host}" -gt 47 ]; then \
		printf '[ERR] MQTT_HOST exceeds 47 characters\n'; exit 1; \
	fi
	@fail=0; \
	for t in $(ZCC) $(Z80ASM) z88dk-appmake grep sed head wc dd $(PYTHON); do \
		command -v "$$t" >/dev/null 2>&1 || { echo "[ERR] Missing tool: $$t"; fail=1; }; \
	done; \
	for f in $(SPECTRUM_SRC) $(SPXN_C_SRCS) $(UART_ASM) $(SPXN_ASMS) $(SHRINK_ASM) $(EDIT_FIELD_ASM) $(SCREEN_ASM) asm/spectrum/text.asm $(OVERLAY_LOADER_ASM) $(PIECE_ASM) tools/gen_overlay_defs.py; do \
		test -f "$$f" || { echo "[ERR] Missing source: $$f"; fail=1; }; \
	done; \
	exit $$fail

test: $(NOTICES_TEST) $(REVERSI_TEST) $(REVERSI_BOARD_RESTORE_TEST) $(SAVEGAME_WIRE_TEST) $(MQTT_TEST) $(MQTT_STREAM_TEST) $(GAME_PROTOCOL_TEST) $(MQTT_SESSION_PROTOCOL_TEST) $(DIRECT_SESSION_PROTOCOL_TEST) $(SESSION_CORE_TEST) $(SESSION_MQTT_PARITY_TEST) $(SESSION_DIRECT_CORE_TEST) $(SESSION_DIRECT_PARITY_TEST) $(SESSION_DIRECT_PARITY_NEXT_TEST) $(KEEPALIVE_PROTOCOL_TEST) $(ESP_AT_TEST) $(ESP_AT_NEXT_TEST) $(UART_PLATFORM_TEST) $(NET_RUNTIME_TEST) $(DIRECT_IPD_TEST) $(SPECTRANEXT_DIRECT_TEST) $(SESSION_CONFIG_TEST) $(APP_CONFIG_FORMAT_TEST) $(CONFIG_OVERLAY_TEST) $(CONFIG_OVERLAY_NEXT_TEST) $(CONFIG_OVERLAY_XFS_TEST) $(SAVELOAD_XFS_TEST) $(SAVELOAD_ESXDOS_TEST) $(SESSION_PING_TEST) $(SESSION_PING_NEXT_TEST) $(SESSION_PING_SPECTRANEXT_TEST) $(SESSION_POLL_TEST) $(SESSION_DIRECT_TEST) $(SESSION_EVENT_TEST) $(SESSION_MQTT_TEST) $(SESSION_OUTGOING_TEST) $(GUI_LOG_TEST) $(GUI_TIMER_TEST) $(STATUS_OVERLAY_TEST) $(FAT_TIMEZONE_TEST) $(FILEUI_PAGING_TEST) tests/tools/test_checker_assets.py tests/tools/test_coin_piece_frames.py tests/tools/test_gen_assets_about.py tests/tools/test_hint_bitmap.py tests/tools/test_setup_flow.py tests/tools/test_next_flip_sprite_slots.py tests/tools/test_next_graphics_bank.py tests/tools/test_next_board_theme_rgb333.py tests/tools/test_tap_image.py tests/tools/test_setup_edit.py tests/tools/test_setup_port.py tests/tools/test_mqtt_connect_packet.py tests/tools/test_spcx_direct_conformance.py tests/tools/test_size_policy.py
	"$(PYTHON)" -m unittest discover -s tests/tools -p "test_checker_assets.py"
	$(PYTHON) tests/tools/test_piece_shine.py
	"$(PYTHON)" tests/tools/test_coin_piece_frames.py
	"$(PYTHON)" -m unittest discover -s tests/tools -p "test_gen_assets_about.py"
	"$(PYTHON)" tests/tools/test_hint_bitmap.py
	"$(PYTHON)" tests/tools/test_tap_image.py
	"$(PYTHON)" tests/tools/test_setup_flow.py
	"$(PYTHON)" tests/tools/test_move_columns.py
	"$(PYTHON)" tests/tools/test_setup_render.py
	"$(PYTHON)" tests/tools/test_setup_time.py
	...
	"$(PYTHON)" tests/tools/test_setup_edit.py --root . --build-dir $(BUILD_DIR)
	"$(PYTHON)" tests/tools/test_setup_port.py --root . --build-dir $(BUILD_DIR)
	"$(PYTHON)" tests/tools/test_mqtt_connect_packet.py --root . --build-dir $(BUILD_DIR)
	"$(PYTHON)" -m unittest tests.tools.test_spcx_direct_conformance
	"$(PYTHON)" tests/tools/test_size_policy.py
	./$(REVERSI_TEST)
	./$(REVERSI_BOARD_RESTORE_TEST)
	./$(SAVEGAME_WIRE_TEST)
	./$(MQTT_TEST)
	./$(MQTT_STREAM_TEST)
	./$(ESP_AT_TEST)
	./$(ESP_AT_NEXT_TEST)
	./$(UART_PLATFORM_TEST)
	./$(UART_PLATFORM_NEXT_TEST)
	./$(MQTT_STREAM_NEXT_TEST)
	./$(NET_RUNTIME_TEST)
	./$(DIRECT_IPD_TEST)
	./$(SPECTRANEXT_DIRECT_TEST)
	./$(GAME_PROTOCOL_TEST)
	...
	./$(CONFIG_OVERLAY_TEST)
	./$(CONFIG_OVERLAY_NEXT_TEST)
	./$(CONFIG_OVERLAY_XFS_TEST)
	./$(SAVELOAD_XFS_TEST)
...
tap-spectranext:
	$(MAKE) NET_BACKEND=spectranext FS_BACKEND=xfs UART_BACKEND=divmmc \
		OVERLAY_BLOCK_SIZE=4096 OVERLAY_SIZE_LIMIT=4096 LOWMEM_LAYOUT=spectranext \
		BUILD_DIR=$(BUILD_DIR)/spectranext \
		RELEASE_DIR=$(RELEASE_DIR)/Spectranext tap
	$(PYTHON) tests/tools/test_spectranext_build.py --build-dir $(BUILD_DIR)/spectranext --atlas $(RELEASE_DIR)/Spectranext/$(ZX_NAME).OVL
	$(PYTHON) tools/gen_size_report.py --map $(BUILD_DIR)/spectranext/$(ZX_NAME).map --code-bin $(BUILD_DIR)/spectranext/$(ZX_NAME)_CODE.bin --tap $(RELEASE_DIR)/Spectranext/$(ZX_NAME).tap --ovl $(RELEASE_DIR)/Spectranext/$(ZX_NAME).OVL --dat $(RELEASE_DIR)/Spectranext/$(ZX_NAME).DAT --overlay-sizes $(BUILD_DIR)/spectranext/overlay_sizes.json --output $(BUILD_DIR)/spectranext/size_report.json --org 28672 --policy z80opt.toml --policy-target spectranext

spectranext-resource: tap-spectranext
	@test -n "$(SPXN_DIR)" || { echo "[ERR] spectranext-resource requires SPXN_DIR=/path/to/SpectraNext/driver"; exit 1; }
	rm -rf $(BUILD_DIR)/spectranext-resource $(RELEASE_DIR)/Spectranext-resource
	"$(PYTHON)" "$(abspath $(SPXN_DIR)/../tools/dev.py)" installer \
		packaging/spectranext/installer.json \
		$(BUILD_DIR)/spectranext-resource \
		--preview $(BUILD_DIR)/installer-preview.png
	cp -R $(BUILD_DIR)/spectranext-resource $(RELEASE_DIR)/Spectranext-resource

nex: $(ZX_NEX)

next-assets: $(NEXT_SPRITE_BIN) $(NEXT_SPRITE_PAL_BIN) $(NEXT_SPRITE_META) $(NEXT_ABOUT_NXI)

.PHONY: next-assets

$(NEXT_SPRITE_BIN) $(NEXT_SPRITE_PAL_BIN) $(NEXT_SPRITE_META): tools/build_next_checker_sprites.py assets/lichess/selected_next_boards.json $(NEXT_SPRITE_SOURCE_PNGS)
	$(PYTHON) tools/build_next_checker_sprites.py

$(NEXT_ABOUT_NXI): tools/build_next_about.py $(NEXT_ABOUT_PNG)
	$(PYTHON) tools/build_next_about.py
...
$(ZX_NEX): $(NEXT_NEX_CONFIG_STAMP) $(NEXT_NEX_INPUTS) tools/gen_next_nex.py tools/gen_next_graphics_defs.py tools/next_bundle_codec.py tests/tools/test_next_bundle_codec.py tests/tools/test_next_graphics_bank.py tests/tools/test_next_overlay_pages.py tests/tools/test_next_paging.py tests/tools/test_next_board_theme_rgb333.py $(NEXT_GRAPHICS_BANK_ASM) $(NEXT_GRAPHICS_BANK_LAYOUT) $(NEXT_RESIDENT_ASM) asm/next/graphics_bank_layout.asm $(NEXT_EXTENSION_INCLUDES) $(NEXT_SPRITE_BIN) $(NEXT_SPRITE_PAL_BIN) $(NEXT_ABOUT_NXI)
	$(MAKE) NET_BACKEND=esp_at FS_BACKEND=esxdos UART_BACKEND=next OVERLAY_LOADER_ASM=$(NEXT_OVERLAY_LOADER_ASM) RESIDENT_EXTRA_ASM=$(NEXT_RESIDENT_ASM) RESIDENT_INCLUDE_DEPS='asm/next/graphics_bank_layout.asm $(NEXT_GRAPHICS_BANK_LAYOUT) $(NEXT_EXTENSION_INCLUDES)' SCREEN_ASM=asm/spectrum/screen.asm OVERLAY_BLOCK_SIZE=8192 OVERLAY_SIZE_LIMIT=4096 ZX_TARGET_CFLAGS='-DNETCHESSZX_NEXT -DNETCHESSZX_NEXT_BANKING -Ca-DNETCHESSZX_NEXT -Ca-DNETCHESSZX_NEXT_BANKING -Ca-DNETCHESSZX_NEXT_RESIDENT' ATLAS_SEED_PROFILE=next BUILD_DIR=$(NEXT_NEX_BUILD_DIR) RELEASE_DIR=$(NEXT_NEX_STAGE_DIR) LOWMEM_LAYOUT=next tap
...
size-baseline: nex-size-baseline tap tools/gen_size_report.py | $(BUILD_DIR)
...
size-check: tap tools/gen_size_report.py | $(BUILD_DIR)
	$(PYTHON) tools/gen_size_report.py --map $(BUILD_DIR)/$(ZX_NAME).map --code-bin $(BUILD_DIR)/$(ZX_NAME)_CODE.bin --tap $(ZX_TAP) --ovl $(ZX_OVL) --dat $(ZX_DAT) --overlay-sizes $(BUILD_DIR)/overlay_sizes.json --output $(SIZE_REPORT) --baseline $(SIZE_BASELINE) --fail-on-missing-baseline --policy z80opt.toml --policy-target zx $(SIZE_CHECK_FLAGS)
...
ifeq ($(HOST_UNAME),Darwin)
	$(CMAKE) -E rm -rf "$(CLIENT_CMAKE_BUILD_DIR)/MirrorShift.app"
endif
	$(CMAKE) --build "$(CLIENT_CMAKE_BUILD_DIR)" --config "$(CLIENT_CMAKE_CONFIG)" --parallel
ifeq ($(HOST_UNAME),Darwin)
	...
	$(CMAKE) -E make_directory \
		...
		"$(CLIENT_CMAKE_BUILD_DIR)/MirrorShift.app/Contents/PlugIns/imageformats"
	...
	$(CODESIGN) --force --deep --sign - "$(CLIENT_CMAKE_BUILD_DIR)/MirrorShift.app"
	$(CODESIGN) --verify --deep --strict "$(CLIENT_CMAKE_BUILD_DIR)/MirrorShift.app"
	$(CMAKE) -E make_directory "$(CLIENT_MAC_APPLICATIONS_DIR)"
	$(CMAKE) -E rm -rf "$(CLIENT_MAC_APPLICATIONS_DIR)/MirrorShift.app"
	$(DITTO) "$(CLIENT_CMAKE_BUILD_DIR)/MirrorShift.app" "$(CLIENT_MAC_APPLICATIONS_DIR)/MirrorShift.app"
endif
...
$(PIECE_ASM): tools/build_checker_sets.py $(CHECKER_PNGS) $(CHECKER_REFLECTION_PNGS)
	$(PYTHON) tools/build_checker_sets.py

$(REFLECTION_BIN): $(PIECE_ASM)
	$(PYTHON) tools/build_checker_sets.py
...
$(BUILD_DAT): tools/gen_assets.py $(ASM_DATA_TOOL) $(ASSET_ASM) $(PIECE_ASM) $(REFLECTION_BIN) $(ABOUT_BOARD) $(SCREEN_ASM) $(OVERLAY_LOADER_ASM) VERSION | $(BUILD_DIR)
...
$(BUILD_CONFIG_STAMP): FORCE tools/write_build_config.py Makefile | $(BUILD_DIR)
	@$(PYTHON) tools/write_build_config.py --out $@ \
		...
		--value "SPXN_DIR_ABS=$(SPXN_DIR_ABS)" \
		--value "OVERLAY_ATLAS_FLAGS=$(OVERLAY_ATLAS_FLAGS)" \
		...
		--value "ATLAS_SEED_PROFILE=$(ATLAS_SEED_PROFILE)" \
		...
		--value "SPXN_TIME_OVL_CFLAGS=$(SPXN_TIME_OVL_CFLAGS)"

$(OVL_ATLAS_TABLE): tools/gen_overlay_atlas.py $(ATLAS_SEED_FILE) $(ATLAS_BINDING_DEPS) | $(BUILD_DIR)
	$(PYTHON) tools/gen_overlay_atlas.py --build-dir $(BUILD_DIR) --name $(ZX_NAME) --out $(BUILD_DIR)/$(ZX_NAME).OVL.bootstrap --asm-out $(OVL_ATLAS_TABLE) --bootstrap-asm --seed-json $(ATLAS_SEED_FILE) --seed-profile $(ATLAS_SEED_PROFILE) --block-size $(OVERLAY_BLOCK_SIZE) --size-limit $(OVERLAY_SIZE_LIMIT) $(OVERLAY_ATLAS_FLAGS) $(ATLAS_BINDING_ARGS)
	@touch $(OVL_ATLAS_TABLE)

$(ZX_TAP): $(BUILD_CONFIG_STAMP) $(SPECTRUM_SRC) src/common/reversi/reversi.c $(SPECTRUM_HEADERS) $(SPXN_RESIDENT_OBJS) $(UART_ASM) $(SHRINK_ASM) $(EDIT_FIELD_ASM) $(SCREEN_ASM) $(RESIDENT_EXTRA_ASM) $(RESIDENT_INCLUDE_DEPS) asm/spectrum/input_queue.asm asm/spectrum/text.asm $(OVERLAY_LOADER_ASM) tools/mirrorshift_bool_copt tools/check_sdcc_iy_contract.py tools/check_tap_image.py $(BUILD_DAT) $(OVL_ATLAS_TABLE) | $(BUILD_DIR) $(RELEASE_DIR)
	...
	@if [ "$(NET_BACKEND)" = "spectranext" ]; then \
		$(PYTHON) tools/check_tap_image.py --map $(BUILD_DIR)/$(ZX_NAME).map --code-bin $(BUILD_DIR)/$(ZX_NAME)_CODE.bin --tap $(BUILD_DIR)/$(ZX_NAME).tap --org $(ZX_ORG) --load-org 0x6e00 --low-code-bin $(BUILD_DIR)/$(ZX_NAME)_spxn_overlay_backend.bin --pack; \
	fi
	...
	$(PYTHON) tools/check_tap_image.py --map $(BUILD_DIR)/$(ZX_NAME).map --code-bin $(BUILD_DIR)/$(ZX_NAME)_CODE.bin --tap $(ZX_TAP) --org $(ZX_ORG) $(if $(filter spectranext,$(NET_BACKEND)),--load-org 0x6e00 --low-code-bin $(BUILD_DIR)/$(ZX_NAME)_spxn_overlay_backend.bin)

$(ZX_OVL): $(ZX_TAP) $(BUILD_CONFIG_STAMP) $(SPECTRUM_HEADERS) $(OVERLAY_SRC) $(SPXN_OVERLAY_SRC) tools/build_overlays.py tools/gen_overlay_defs.py tools/gen_overlay_atlas.py | $(BUILD_DIR) $(RELEASE_DIR)
	@\
	 ATLAS_FINAL="$(ATLAS_FINAL)" BUILD_DIR="$(BUILD_DIR)" BUILD_DIR_UP="$(BUILD_DIR_UP)" EDIT_BUF_OVL="$(EDIT_BUF_OVL)" \
	 ESX_COMMON_ASM="$(ESX_COMMON_ASM)" ESX_FILEUI_ASM="$(ESX_FILEUI_ASM)" ESX_FILEUI_OBJ="$(ESX_FILEUI_OBJ)" ESX_SAVELOAD_ASM="$(ESX_SAVELOAD_ASM)" ESX_SAVELOAD_OBJ="$(ESX_SAVELOAD_OBJ)" \
	 GAME_PROTOCOL_MACH_SRC="$(GAME_PROTOCOL_MACH_SRC)" MAKE="$(MAKE)" MQTT_CONNECT_OVL_CFLAGS="$(MQTT_CONNECT_OVL_CFLAGS)" NET_BACKEND="$(NET_BACKEND)" \
	 OVERLAY_ATLAS_FLAGS="$(OVERLAY_ATLAS_FLAGS)" OVL_ATLAS_TABLE="$(OVL_ATLAS_TABLE)" OVL_DEFS="$(OVL_DEFS)" PYTHON="$(PYTHON)" \
	 OVERLAY_BLOCK_SIZE="$(OVERLAY_BLOCK_SIZE)" OVERLAY_SIZE_LIMIT="$(OVERLAY_SIZE_LIMIT)" \
	 SPXN_ATOMIC_OBJ="$(SPXN_ATOMIC_OBJ)" SPXN_ATOMIC_SRC="$(SPXN_ATOMIC_SRC)" SPXN_TIME_OVL_CFLAGS="$(SPXN_TIME_OVL_CFLAGS)" SPXN_TIME_SRC="$(SPXN_TIME_SRC)" \
	 SPXN_UDP_SRC="$(SPXN_UDP_SRC)" ZCC="$(ZCC)" ZX_NAME="$(ZX_NAME)" ZX_OVL="$(ZX_OVL)" \
	 ZX_OVL_CFLAGS="$(ZX_OVL_CFLAGS)" ZX_Z80ASM="$(ZX_Z80ASM)" \
	 "$(PYTHON)" tools/build_overlays.py

export SPXN_RESOLVE_C SPXN_XFS_OVERLAY_ASM ATLAS_BINDING_ARGS

test: spectranext-pagination-test
.PHONY: spectranext-pagination-test
spectranext-pagination-test:
	$(PYTHON) tests/tools/test_spectranext_overlay_pages.py --build-dir $(BUILD_DIR)
ifneq ($(strip $(SPXN_DIR)),)
	$(PYTHON) tests/tools/test_spectranext_rom_held.py --build-dir $(BUILD_DIR) --spxn-dir $(SPXN_DIR)
endif

ifneq ($(SPXN_DIR_ABS),)
$(BUILD_DIR)/spxn.o: $(SPXN_DIR_ABS)/spxn.c $(wildcard $(SPXN_DIR_ABS)/*.h) $(BUILD_CONFIG_STAMP) | $(BUILD_DIR)
	cd $(BUILD_DIR) && $(ZCC) +z80 $(filter-out -m,$(ZX_OVL_CFLAGS)) -c $(SPXN_DIR_ABS)/spxn.c -o spxn.o

$(BUILD_DIR)/spxn_stream.o: $(SPXN_DIR_ABS)/spxn_stream.c $(wildcard $(SPXN_DIR_ABS)/*.h) $(BUILD_CONFIG_STAMP) | $(BUILD_DIR)
	cd $(BUILD_DIR) && $(ZCC) +z80 $(filter-out -m,$(ZX_OVL_CFLAGS)) -c $(SPXN_DIR_ABS)/spxn_stream.c -o spxn_stream.o

$(BUILD_DIR)/spxn_rom.o: $(SPXN_DIR_ABS)/spxn_rom.asm $(BUILD_CONFIG_STAMP) | $(BUILD_DIR)
	cp -f $(SPXN_DIR_ABS)/spxn_rom.asm $(BUILD_DIR)/spxn_rom.asm
	cd $(BUILD_DIR) && $(ZX_Z80ASM) spxn_rom.asm

$(BUILD_DIR)/xfs_loader_spectranext.o: asm/esxdos/xfs_loader_spectranext.asm $(BUILD_CONFIG_STAMP) | $(BUILD_DIR)
...
test: board-animation-test
.PHONY: board-animation-test
board-animation-test:
	$(PYTHON) tests/tools/test_board_animation.py --build-dir $(BUILD_DIR)
