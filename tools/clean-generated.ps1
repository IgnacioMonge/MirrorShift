...
if (-not $ClientOnly) {
    ...
    Remove-GeneratedPath "release\MIRSHIFT.tap"
    Remove-GeneratedPath "release\MIRSHIFT.OVL"
    Remove-GeneratedPath "release\MIRSHIFT.DAT"
...
if (-not $SpectrumOnly) {
    ...
    Remove-GeneratedPath "release\MirrorShift"
    Remove-EmptyGeneratedDir "release"
